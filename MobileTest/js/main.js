...
var wx = is_weixn();
if(!wx==true){
	$('.dl_android').attr('href','http://download.wqn.ztgame.com.cn/proj.apk');
	$('.dl_iphone').attr('href','itms-services://?action=download-manifest&amp;url=https://zt.pukeng.com/download/wqn.plist')
